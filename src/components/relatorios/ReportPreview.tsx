...
export function ReportPreview({ r }: { r: Report }) {
  ...
  const enviarWhats = async () => {
    ...
    // Abre a aba já no clique (evita bloqueio de popup após o await).
    ...
    try {
      ...
      // Celular: compartilha o arquivo direto (anexa no WhatsApp).
      ...
      // Desktop: baixa o PDF para anexar e leva a aba pré-aberta ao WhatsApp.
