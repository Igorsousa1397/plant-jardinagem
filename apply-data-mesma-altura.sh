#!/usr/bin/env bash
# Plant Jardinagem — iguala a altura do campo Data ao de Duração
set -e
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="min-w-0">
            <Field label="Data do serviço">
              <input type="date" value={data} onChange={(e) => setData(e.target.value)} className={`${inputClass} min-w-0 appearance-none`} />
            </Field>
          </div>
          <div className="min-w-0">
            <Field label="Duração">
